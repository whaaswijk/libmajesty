...
private:
  ...
  const std::vector<tt> tts = { tt(std::string("1010101010101010101010101010101010101010101010101010101010101010")),
								 tt(std::string("1100110011001100110011001100110011001100110011001100110011001100")),
								 tt(std::string("1111000011110000111100001111000011110000111100001111000011110000")),
								 tt(std::string("1111111100000000111111110000000011111111000000001111111100000000")),
								 tt(std::string("1111111111111111000000000000000011111111111111110000000000000000")),
								 tt(std::string("1111111111111111111111111111111100000000000000000000000000000000")) };
